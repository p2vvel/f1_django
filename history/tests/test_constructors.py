...
class ConstructorViewTests(TestCase):
    ...
    def test_drivers_data(self):
        ...
        driver1 = create_driver(name="Michael",
                                surname="Schumacher",
                                nickname="schumacher")
        driver2 = create_driver(name="Fernando",
                                surname="Alonso",
                                nickname="nando")
        driver3 = create_driver(name="Kimi",
                                surname="Raikonnen",
                                nickname="iceman")
        driver4 = create_driver(name="Sebastian",
                                surname="Vettel",
                                nickname="vet")
        driver5 = create_driver(name="Charles",
                                surname="Leclerc",
                                nickname="lec")
        ...
        race1 = create_race(circuit=circuit,
                            name="Monza1",
                            date=datetime.now(),
                            year=2008,
                            round=7)
        race2 = create_race(circuit=circuit,
                            name="Monza2",
                            date=datetime.now(),
                            year=2009,
                            round=3)
        race3 = create_race(circuit=circuit,
                            name="Monza3",
                            date=datetime.now(),
                            year=2010,
                            round=4)
        race4 = create_race(circuit=circuit,
                            name="Monza4",
                            date=datetime.now(),
                            year=2011,
                            round=5)

        result1 = create_result(race=race1,
                                constructor=constructor,
                                status=status,
                                driver=driver1)
        result2 = create_result(race=race1,
                                constructor=constructor,
                                status=status,
                                driver=driver2)

        result3 = create_result(race=race2,
                                constructor=constructor,
                                status=status,
                                driver=driver1)
        result4 = create_result(race=race2,
                                constructor=constructor,
                                status=status,
                                driver=driver2)

        result5 = create_result(race=race3,
                                constructor=constructor,
                                status=status,
                                driver=driver2)
        result6 = create_result(race=race3,
                                constructor=constructor,
                                status=status,
                                driver=driver3)

        result7 = create_result(race=race4,
                                constructor=constructor,
                                status=status,
                                driver=driver3)
        result8 = create_result(race=race4,
                                constructor=constructor,
                                status=status,
                                driver=driver4)
        result9 = create_result(race=race4,
                                constructor=constructor,
                                status=status,
                                driver=driver5)
